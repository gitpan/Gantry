package JobAd::Position;

use strict;

use base 'JobAd::GEN::Position';
...
# $self->do_main(  )
#-----------------------------------------------------------------
# This method supplied by JobAd::GEN::Position
...
=head1 METHODS MIXED IN FROM JobAd::GEN::Position
